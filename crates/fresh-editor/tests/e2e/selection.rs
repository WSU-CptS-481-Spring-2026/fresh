...
fn test_selection_visual_rendering() {
    ...
    // Gutter takes up 5 characters: " " (indicator) + "1" (line num) + " │ " (separator)
    // So "Hello" starts at column 5
    ...
    // Check first character 'H' at position (5, first_line_row) - should have selection background
    let h_pos = buffer.index_of(5, first_line_row);
    ...
    // Check fourth character 'l' at position (8, first_line_row) - should have selection background
    let l_pos = buffer.index_of(8, first_line_row);
    ...
    // Check fifth character 'o' at position (9, first_line_row) - byte position 4, IN selection
    let o_pos = buffer.index_of(9, first_line_row);
    ...
    // Check character ' ' (space) at position (10, first_line_row) - byte position 5, cursor position
    let space_pos = buffer.index_of(10, first_line_row);
